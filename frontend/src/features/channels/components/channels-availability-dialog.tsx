...
export function ChannelsAvailabilityDialog({ open, onOpenChange, currentRow, onChannelChange }: Props) {
  ...
  const onSubmit = useCallback(
        ...
        const updatedChannel = await updateChannel.mutateAsync({
          ...
          input: {
            ...
            policies: {
              ...
              channelAutoDisable: currentPolicies?.channelAutoDisable,
    ...
    [currentPolicies?.channelAutoDisable, currentPolicies?.stream, currentRow.id, onChannelChange, onOpenChange, t, updateChannel]
  );
