    ...
    <DialogPortal data-slot='dialog-portal'>
      <DialogOverlay>
        <DialogPrimitive.Content
          ...
          className={cn(
            'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative z-50 grid w-full max-w-[calc(100%-2rem)] max-h-[90vh] gap-4 overflow-y-auto rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg',
            className
          )}
          onInteractOutside={(e) => {
            e.preventDefault();
